...
TABLESPACES_EXTENSIONSTablespace attributes
...
The type of constraint. The value can be UNIQUE, PRIMARY KEY, FOREIGN KEY, or (as of MySQL
...
The VIEW_TABLE_USAGE table (available as of MySQL 8.0.13) provides access to information about
...
INNODB_CMP_PER_INDEX_RESETStatus for operations related to
compressed InnoDB tables and
indexes
...
INNODB_FT_DEFAULT_STOPWORDDefault list of stopwords for
...
INNODB_TABLESPACES_BRIEF Brief file-per-table, general,
...
The INFORMATION_SCHEMA INNODB_FOREIGN_COLS Table
...
TABLE ... ADD COLUMN with ALGORITHM=INSTANT. This column is no longer used as of MySQL
8.0.29 but continues to show information for tables with columns that were added instantly prior to
MySQL 8.0.29.
...
As of MySQL 8.0.14, the INFORMATION_SCHEMA thread pool tables are also
available as Performance Schema tables. (See Section 29.12.16, “Performance
...
also available as Performance Schema tables. (See Section 29.12.16,
...
table, see Section 29.12.16.1, “The tp_thread_group_state Table”. The Performance Schema
...
table, see Section 29.12.16.2, “The tp_thread_group_stats Table”. The Performance Schema
...
Section 29.12.16.3, “The tp_thread_state Table”. The Performance Schema tp_thread_state table
