...
**Date:** 2021/10
**Source:** http://mysql.taobao.org/monthly/2021/10/01/
...
![insert_undo_record](.img/fbb5ba6ce755_insert_undo_record.png)
...
![update_undo_record](.img/f966bd0de2a4_update_undo_record.png)
...
![undo_log](.img/085c80ece591_undo_log.png)
...
![undo_logicial](.img/1d6c1ed3068b_undo_logical.png)
...
![undo_physical](.img/139729af63d4_undo_physical.png)
...
![undo_tablespace](.img/63fdc5d56f80_undo_tablespace.png)

### 内存组织结构

上面介绍的都是Undo数据在磁盘上的组织结构，除此之外，在内存中也会维护对应的数据结构来管理Undo Log，如下图所示：

![undo_memory](.img/91cc69726878_undo_memory.png)
...
![undo_rollback](.img/cd6d23cbf7ca_undo_rollback.png)
...
![undo_mvcc](.img/9a70b55373f4_undo_mvcc.png)
...
![undo_purge](.img/91c51624c6ea_undo_purge.png)
...
![undo_purge_1](.img/49e2274c00a0_undo_purge_1.png)
...
![undo_purge_2](.img/aaa361490eba_undo_purge_2.png)
...
[3] [The basics of the InnoDB undo logging and history system](https://blog.jcole.us/2014/04/16/the-basics-of-the-innodb-undo-logging-and-history-system/#:~:text=InnoDB%20keeps%20a%20copy%20of%20everything%20that%20is%20changed&text=It) 
